...
const TestimonialsData = [
  ...
  },
  {
    rating: 5,
    review:
              "Really like the clean design of TaskWise. The AI-driven categorization is impressively accurate, adding a personal dimension to my task management. Fast and very easy to use.",
    name: "John Collins",
    designation: "Engineer & Author",
    profile: "/images/profile.png",
    feature: true,
  ...
  {
    rating: 5,
            review: "Simply brilliant! TaskWise has elevated my productivity.",
    name: "Moe Partuj",
    designation: "Student",
...
//     <section
//       id="reviews"
//       className="bg-[#f5faff] relative overflow-hidden"
//     >
//       <Image
